...
var actionTab = actionTable{
	...
	actionRow{ // S108
		...
		actions: [numSymbols]action{
			...
			nil,        // l_square_par
			nil,        // r_square_par
			reduce(36), // l_curly_par, reduce: CycleTail
			nil,        // r_curly_par
			nil,        // assign
			nil,        // if
			nil,        // else
